...
const loadingAutocompleteList = current => ({ type: ACTION_TYPES_AUTOCOMPLETE.LOADING_AUTOCOMPLETE, current });
const updateAutocompleteList = list => ({ type: ACTION_TYPES_AUTOCOMPLETE.UPDATE_AUTOCOMPLETE, list });
